...
app.get('/player_info/post',function(req,res)	{
  var getID = req.query.player_choice;
  if(getID != "Select Player"){
	  var player1 = 'SELECT id,name FROM football_players;';
	  var player2 = 'SELECT * FROM football_players WHERE id = ' + getID + ';';
	  var player3 = 'SELECT COUNT(*) FROM football_games WHERE ' + getID + ' = ANY(players);';
	  db.task('get-everything', task => {
	    return task.batch([
	        task.any(player1),
	        task.any(player2),
